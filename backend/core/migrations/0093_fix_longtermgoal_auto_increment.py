# Generated manually to fix LongTermGoal table AUTO_INCREMENT issue
...
def fix_auto_increment(apps, schema_editor):
    """
    修复 LongTermGoal 表的 id 字段，确保它是 AUTO_INCREMENT。
        ...
        with schema_editor.connection.cursor() as cursor:
            ...
            try:
                ...
                try:
                    ...
                    pass
                # 不抛出异常，允许迁移继续
                print(f"   跳过 {table_name}，继续...")
    else:
        print(f"⚠ 非 MySQL/MariaDB 数据库，跳过 AUTO_INCREMENT 修复")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0092_add_yearly_goal_fields"),
    ]
