...
function ProfileDashboard({
  ...
  onOpenAchievements,
  pinnedAchievements,
  recentAchievements: _recentAchievements, // eslint-disable-line @typescript-eslint/no-unused-vars
  membershipTier,
  onOpenMembership,
  artworks,
  ...
  return (
    <div className="profile-page">
      ...
      <main className="profile-page__content">
        ...
        <section className="profile-page__badges" onClick={onOpenAchievements}>
          ...
          {onOpenAchievements && (
            <MaterialIcon name="chevron_right" className="profile-page__badges-chevron" />
          )}
        </section>
